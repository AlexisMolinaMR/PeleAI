...
from utils.utils import write_regression_report_GBR, write_regression_report_XGBR, write_regression_report_LGBR, write_regression_report_MLPR

from preprocessing.preprocessing import dataset_preparation, data_splitting_regression, data_splitting_classification, Scaler
...
def main():
    ...
    if 'path_graph' in param_args or pipe:
        ...
        if param_args['task'] == 'classification':
            ...
            train, bindingEnergy_train, test, bindingEnergy_test, ligands_test = data_splitting_regression(
                data=data, test_size=param_args['test_size'], seed=param_args['seed'])
